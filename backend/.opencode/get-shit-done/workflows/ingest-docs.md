...
```bash
INIT=$(node "/Users/gabrielesuardi/Desktop/be-roscoff/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/gabrielesuardi/Desktop/be-roscoff/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
