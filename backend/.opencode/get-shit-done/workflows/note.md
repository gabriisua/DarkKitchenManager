...
- **Global scope**: `/Users/gabrielesuardi/Desktop/be-roscoff/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/gabrielesuardi/Desktop/be-roscoff/.opencode/notes/`)
...
2. Glob `/Users/gabrielesuardi/Desktop/be-roscoff/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/gabrielesuardi/Desktop/be-roscoff/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/gabrielesuardi/Desktop/be-roscoff/.opencode/notes/` — works in any directory
