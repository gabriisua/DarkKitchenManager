...
```
Task(
  prompt="Read /Users/gabrielesuardi/Desktop/be-roscoff/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/gabrielesuardi/Desktop/be-roscoff/.opencode/get-shit-done/templates/SECURITY.md`
