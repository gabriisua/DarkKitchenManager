...
- **Global scope**: `/Users/gabrielesuardi/Desktop/fe-roscoff/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/gabrielesuardi/Desktop/fe-roscoff/.opencode/notes/`)
...
2. Glob `/Users/gabrielesuardi/Desktop/fe-roscoff/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/gabrielesuardi/Desktop/fe-roscoff/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/gabrielesuardi/Desktop/fe-roscoff/.opencode/notes/` — works in any directory
