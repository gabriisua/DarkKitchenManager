...
```bash
INIT=$(node "/Users/gabrielesuardi/Desktop/fe-roscoff/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/gabrielesuardi/Desktop/fe-roscoff/.opencode/get-shit-done/templates/spec.md.
