...
```
Task(
  prompt="Read /Users/gabrielesuardi/Desktop/fe-roscoff/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/gabrielesuardi/Desktop/fe-roscoff/.opencode/get-shit-done/templates/VALIDATION.md`
